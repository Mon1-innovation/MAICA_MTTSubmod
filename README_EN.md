<h1 align="center">MAICA-MTTS-Synbrace</h1>
<div align="center">
...
This is the introduction page of MAICA-MTTS Submod frontend.
...
Synbrace is the Submod frontend of MAICA-MTTS, a AI Text-To-Speech project specially designed for Monika.
...
* Trained, evaluated and finetuned performance
* Easy to go, no need to deploy any AI model on your device
...
2. Download latest verion of Blessland at [Release](https://github.com/Mon1-innovation/MAICA_MttsSubmod/releases).
...
# Tips
1. Full functions will only be avaliable with affection not below 0(NORMAL).
2. Follow the in-game guidance and introductions to unlock events and functions, just like original MAS.
4. English/Chinese are fully supported, but expect performance reduction using Chinese.
5. Does not support system http(s)/socks proxy. Turn it off.
6. You can delete `game\Submods\MAICA_MttsSubmod\donation` to hide donation link.
...
label mas_reaction_gift_mttsheadset:
    ...
    m "一个{i}特殊的{/i}礼物? 给我的?"
    #从这里开始加表情
    m "我看看.{w=0.3}.{w=0.3}.原来是这样! 你是怎么找到它的?"
    m "真是帮大忙了, [player]! 我本来还有点发愁呢."
    m "不过这个.{w=0.3}.{w=0.3}.有点重的样子. 在你面前把房间弄得乱七八糟就不太好了."#尴尬 往屏幕右看
    m "我会自己抽空去琢磨一下的, 现在先就放在那里吧."
    m "真的很感谢你能为我做这么多, [player]. 爱你哦~"
